...
//    arm_set(shelf_floor);
    ...
    if (x_now > x_mid && y_now != 4) {
      get_stack_left(x_now - x_mid);
      robot_left();
      x_now = x_mid;
    }else if (x_now > x_mid && y_now == 4) {
      get_stack_right(x_now - x_mid);
      robot_left();
      x_now = x_mid;
    }else if (x_now < x_mid && y_now != 4) {
      get_stack_right(x_mid - x_now);
      robot_right();
      x_now = x_mid;
    }else if (x_now < x_mid && y_now == 4) {
      get_stack_left(x_mid - x_now);
      robot_right();
      x_now = x_mid;
    }
    ...
    if (x_now > x_mid) {
      get_stack_left(1);
      robot_left();
      get_stack(x_now - x_mid);
      robot_right();
      x_now = x_mid;
    }else {
      get_stack_right(1);
      robot_right();
      get_stack(x_mid - x_now);
      robot_left();
      x_now = x_mid;
    }
    ...
    if (x_need != x_max && y_now != 4) {
      robot_left();
      get_stack_left(1);
    }else if (x_need != x_max && y_now == 4) {
      robot_left();
      get_stack_right(1);
    }else if (x_need == x_max && y_now != 4) {
      robot_right();
